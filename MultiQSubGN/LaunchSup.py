...
def generate_launch_description():
    ...
    for i in range(number_drones):
        ...
        # Individual map handler of the drone
        mapper = Node(
        ...
        # Movement handler and brain of the drone
        mover = Node(
        package='moving_try',
        ...
        parameters=[
            ...
            {'strategy': [random.choice([0,1,2,3,4,5,6,7])]},
            {'starting_x': x[i]},
            {'starting_y': y[i]},
            {'hidder': h},
            {'n': trials},
    ...
    # Handles the shared map information
    globa = Node(
        package='global_Map',
    ...
    # Multi coordinator for the overall group management
    coor = Node(
    ...
    # The substitute idle movemenent handler
    key = Node(
        package='keyboard',
        executable='keyboard',
        name='sub',
